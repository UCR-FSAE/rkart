...
namespace ROAR
{
    namespace GlobalPlanning
    {
        ...
        {
            typedef std::shared_ptr<NavPlannerConfig> SharedPtr;
            typedef std::unique_ptr<NavPlannerConfig> UniquePtr;
        ...
        /**
         * This class serves as an isolation layer between User interaction, ROS2 and the actual planner algorithm
         **/
        ...
        private:
            ...
            std::unique_ptr<NavPlannerInterface> m_nav_planner_algo; // Change this line
            ...
            // transform goal pose from base_link to map
            geometry_msgs::msg::PoseStamped::SharedPtr p_transformGoalPoseToMap(const geometry_msgs::msg::PoseStamped::SharedPtr goal_pose, const nav_msgs::msg::OccupancyGrid::SharedPtr global_map);
            ...
            NavPlannerConfig::SharedPtr m_config_;
        };
    }
} // namespace ROAR
